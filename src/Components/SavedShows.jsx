      ...
      <div className='relative flex items-center group'>
        ...
        >
          {movies.map((item, id) => (
            <div
              key={id}
              className='w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block cursor-pointer relative p-2 transition-all duration-300 hover:scale-110'
            >
              <img src={`https://image.tmdb.org/t/p/original/${item?.img}`} alt={item.title} />
